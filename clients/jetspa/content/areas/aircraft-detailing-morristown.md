...
localCopy:
  ...
  body: |
    Morristown-based aircraft face the same appearance care challenges as any high-traffic Northeast airport, plus a few specific to the field. Winter operations include heavy deicing chemistry exposure that accumulates on paint and de-ice boots. Summer humidity and airborne particulate accelerate paint oxidation and interior cabin wear. Corporate flight departments based at KMMU expect coordinated scheduling that respects tight maintenance and dispatch windows.
...
whyUs:
  ...
  body: |
    Every aircraft we service at KMMU comes with the same commitments:
